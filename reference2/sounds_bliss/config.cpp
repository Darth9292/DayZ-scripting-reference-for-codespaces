	...
	class Enoch: CAWorld
	{
		class EnvSounds
		{
			...
			class CfgEnvSpatialSounds
			{
				...
				class sound_buoy_floating_water
				{
					memPoint="sound_buoy_floating_water";
					soundSets[]=
					{
						"buoy_floating_water_SoundSet"
					};
				};
				class sound_wind_object_metal_wrecks_stress
				{
					memPoint="sound_wind_object_metal_wrecks_stress";
					soundSets[]=
					{
						"wind_object_metal_wrecks_stress_SoundSet"
					};
				};
				class sound_wind_object_metal_wrecks_stress_2
				{
					memPoint="sound_wind_object_metal_wrecks_stress_2";
					soundSets[]=
					{
						"wind_object_metal_wrecks_stress_SoundSet"
					};
