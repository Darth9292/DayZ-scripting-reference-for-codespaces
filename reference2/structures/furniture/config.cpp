...
class CfgVehicles
{
	...
	class StaticObj_Furniture_PaperBox_01_small_closed: HouseNoDestruct
	{
		scope=1;
		model="DZ\structures\Furniture\Cases\PaperBox\PaperBox_01_small_closed.p3d";
	};
	class StaticObj_Furniture_PaperBox_01_small_destroyed: HouseNoDestruct
	{
		scope=1;
		model="DZ\structures\Furniture\Cases\PaperBox\PaperBox_01_small_destroyed.p3d";
	};
	class StaticObj_Furniture_PaperBox_01_small_open: HouseNoDestruct
	{
		scope=1;
		model="DZ\structures\Furniture\Cases\PaperBox\PaperBox_01_small_open.p3d";
	};
	class StaticObj_Furniture_PaperBox_01_small_ransacked: HouseNoDestruct
	{
		scope=1;
		model="DZ\structures\Furniture\Cases\PaperBox\PaperBox_01_small_ransacked.p3d";
	};
	class StaticObj_Furniture_PlasticBucket: HouseNoDestruct
	{
		scope=1;
	...
	class StaticObj_Furniture_MedicalGarbage_Bandage: HouseNoDestruct
	{
		scope=1;
	...
	class StaticObj_Furniture_toilet_b_02_V2: HouseNoDestruct
	{
		scope=1;
		model="DZ\structures\Furniture\Bathroom\toilet_b_02\toilet_b_02_V2.p3d";
	};
