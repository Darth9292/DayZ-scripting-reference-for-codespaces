...
class CfgNonAIVehicles
{
	...
	class Static_stone7_Trail_B: StaticObject
	{
	};
	class Static_stone7_Trail_G: StaticObject
	{
	};
	class Static_stone7_Trail_R: StaticObject
	{
	};
	class Static_stone7_Trail_Y: StaticObject
	{
	};
};
