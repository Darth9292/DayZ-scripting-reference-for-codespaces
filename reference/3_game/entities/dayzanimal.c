...
class DayZCreatureAI extends DayZCreature 
{
	...
	*/
	...
	{
		super.EEKilled(kill		CreateComponent(COMP_TYPE_BODY_STAGING); // TO DO: This is never called on clients in multiplayer! That's why skinning doesn't work properly in MP. DAYZ-28269
	}
